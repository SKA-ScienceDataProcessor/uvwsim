...
![Figure showing scatter plot of example baselines. see: doc/example.png in the library source tree](http://www.oerc.ox.ac.uk/~ska/uvwsim/test.png "Scatter plot of baselines from the example code.")
